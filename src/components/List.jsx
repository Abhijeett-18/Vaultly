  ...
  return (
    <div className="mt-10 space-y-3">
      ...
      {filtered.map((entry, i) => (
        <div key={i}>
          <div className="mx-4 text-white p-4 rounded flex justify-between items-center">
            {editIndex === i ? (
              <div className="flex flex-col gap-1">
                <input
                  className="bg-orange-50 text-stone-900 p-1 rounded"
              ...
              {editIndex === i ? (
                ...
                <>
                  <button
                    ...
                    className="bg-blue-800 hover:bg-blue-900 px-2 py-1 rounded"
                  >
                    Copy
                  </button>
                  <button
                    onClick={() => handleEdit(i)}
                    className="bg-green-800 px-2 py-1 rounded hover:bg-green-900"
                  >
                    Edit
                  </button>
                  <button
          ...
          {i !== filtered.length - 1 && (
            <hr className="mx-4 border-t border-gray-600 opacity-40 my-2" />
          )}
        </div>
      ))}
    </div>
